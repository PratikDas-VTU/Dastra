...
class PdfToWordOptionsCard extends StatelessWidget {
  const PdfToWordOptionsCard({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Icon(Icons.document_scanner_rounded, color: context.colors.accentBlue, size: 20),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 8),
                        _buildSummaryRow(context, 'Total Pages', '${ctrl.job!.pageCount ?? 0}'),
                      ],
                    ),
                  ),
                  const SizedBox(height: 24),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          'The PDF to Word engine is not installed. Download it now to proceed.',
